...
const url_Provider = process.env.UNINET_LANWLAN_URL;
const username = process.env.UNINET_LANWLAN_USERNAME;
const password = process.env.UNINET_LANWLAN_PASSWORD;

async function createTicketUninetLanWlan(data = null, stringsData = null,DataImages = null) {
...
`;
    ...
    const xmlResponse = await consumirApi_Soap(`${url_Provider}`, 'POST', {}, xmlRequest, "UNINET_LAN_WLAN",{username: username,password: password},'Create');
...
async function updateTicketUninetWlan(data = null, TIC_ID_EXTERNO_PROVEEDOR = null, tic_newId= null) {
    let typeCalif = null;
...
`;
    ...
    const xmlResponse = await consumirApi_Soap(`${url_Provider}`, 'POST', {}, xmlRequest, "UNINET_LAN_WLAN",{username: username,password: password},'Update');
...
async function uploadImagesTicketUninetWlan(DataImages) {
...
// Exportar la función
module.exports = { createTicketUninetLanWlan, updateTicketUninetWlan ,uploadImagesTicketUninetWlan};